...
COMMIT;
Insert into JOB_HISTORY (EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) Values (102, TO_DATE('01/13/1993 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('07/24/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'IT_PROG', 60);
Insert into JOB_HISTORY (EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) Values (101, TO_DATE('09/21/1989 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('10/27/1993 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'AC_ACCOUNT', 110);
Insert into JOB_HISTORY (EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) Values (101, TO_DATE('10/28/1993 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('03/15/1997 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'AC_MGR', 110);
Insert into JOB_HISTORY (EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) Values (201, TO_DATE('02/17/1996 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('12/19/1999 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'MK_REP', 20);
Insert into JOB_HISTORY (EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) Values (114, TO_DATE('03/24/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('12/31/1999 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'ST_CLERK', 50);
Insert into JOB_HISTORY (EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) Values (122, TO_DATE('01/01/1999 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('12/31/1999 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'ST_CLERK', 50);
Insert into JOB_HISTORY (EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) Values (200, TO_DATE('09/17/1987 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('06/17/1993 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'AD_ASST', 90);
Insert into JOB_HISTORY (EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) Values (176, TO_DATE('03/24/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('12/31/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'SA_REP', 80);
Insert into JOB_HISTORY (EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) Values (176, TO_DATE('01/01/1999 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('12/31/1999 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'SA_MAN', 80);
Insert into JOB_HISTORY (EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) Values (200, TO_DATE('07/01/1994 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('12/31/1998 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 'AC_ACCOUNT', 90);
COMMIT;
